...
mutable struct DOCP{
    ...
    function DOCP(ocp::CTModels.Model, grid_size::Int, control_steps::Int, scheme::Symbol, time_grid)
        ...
        elseif scheme == :gauss_legendre_2_constant_control
            discretization, dim_NLP_variables, dim_NLP_constraints = 
            CTDirect.Gauss_Legendre_2(disc_args...)

        elseif scheme == :gauss_legendre_3_constant_control
            discretization, dim_NLP_variables, dim_NLP_constraints = 
        ...
        elseif scheme == :gauss_legendre_3
            ...
            error(
                ...
                scheme,
                "\nValid options are scheme={:trapeze, :midpoint, :euler | :euler_explicit | :euler_forward, :euler_implicit | :euler_backward, :gauss_legendre_2, :gauss_legendre_3, :gauss_legendre_2_constant_control, :gauss_legendre_3_constant_control}\n",
                typeof(scheme),
            )
        end
